        ...
        <div className='body-container'>
            ...
            <div className='body-div'>
                <div className='body-div_div'>
                    ...
                    <div>
                        <button className="body-submit_button">Update</button>
                    </div>
                </div>
            </div>
            <div className='body-div'>
                    ...
                    <div className="body-stats_div">
                        <div >
                            ...
                            <div style={{margin:'3px 0 3px 20px'}}>
                                <p style={{fontWeight:"1000",fontSize:'20px',margin:'2px 2px 4px'}}><strong>12,890</strong></p>
                        ...
                        <div >
                            ...
                            <div style={{margin:'3px 0 3px 20px'}}>
                                <p style={{fontWeight:"1000",fontSize:'20px',margin:'2px 2px 4px'}}><strong>37%</strong></p>
                        ...
                        <div style={{border:0,width:'90%'}}>
                            ...
                            <div style={{margin:'3px 0 3px 20px'}}>
                                <p style={{fontWeight:"1000",fontSize:'20px',margin:'2px 2px 4px'}}><strong>07 / 15</strong></p>
            ...
            <div className='body-div'>
                <div className='body-header'>
                    <div style={{width:'70%'}}>
                        ...
                        <div style={{margin:'15px 0 0'}}>You scored 37% Percentile which is lower than the average Percentile 72% of all engineers who took the assessment</div>
                    </div>
